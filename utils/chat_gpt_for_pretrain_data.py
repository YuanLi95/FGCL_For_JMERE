...
def process(data_set_path):
    ...
    openai.api_key = "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"
    file = json.load(open(data_set_path))

    with jsonlines.open("../no_none_unified_tags_txt/pre_train_data.json", "a") as f:
...
if __name__ == '__main__':
    train_path = "../pre_train_data/pre_train_data.json"
    process(train_path )
