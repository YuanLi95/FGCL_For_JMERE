...
class Metric():
    ...
    def score_entity(self):
        ...
        for i in range(self.data_num):
            ...
            for spans in golden_aspect_spans:
                ...
                # new_set.append(str(i) + '-' + '-'.join(map(str, spans)))
                golden_set.add(str(i) + '-' + '-'.join(map(str, spans)))
            # golden_list.append(new_set)
            # new_set_2 = []
            ...
            for spans in predicted_aspect_spans:
                ...
                # new_set_2.append(str(i) + '-' + '-'.join(map(str, spans)))
            # predicted_list.append(new_set_2)

        # for j in  range(self.data_num):
        #     print("this is golden :{0}--------------------\n this is predicted:{1}".format(golden_list[j],predicted_list[j]))
        #
    ...
    def score_uniontags(self,print_result):
        ...
        for i in range(self.data_num):
            ...
            for pair in golden_tuples:
                new_set.append(str(i) + '-' + '-'.join(map(str, pair)))
            ...
            for pair in predicted_tuples:
                new_set_2.append(str(i) + '-' + '-'.join(map(str, pair)))
